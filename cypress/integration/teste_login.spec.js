...
describe('teste login', () => {
    ...
    it('Realizar login com credenciais corretas e impedir login ao inserir credenciais invalidas', () => {
        ...
        cy.get('input[id="inputEmail"]').wait(2000).type('lucas@gmail.com')
        cy.get('input[id="inputPassword"]').wait(2000).type('@Lucas123')
        ...
        cy.get('input[id="inputEmail"]').wait(2000).type('testelogininvalido@isee.com')
